        ...
        <div className="container-custom py-12">
          ...
          <section className="bg-white rounded-2xl p-8 mb-12">
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              ...
              يمكنك إرجاعه خلال <strong>14 يوماً</strong> من تاريخ الاستلام واسترداد قيمة المنتج. تكلفة الشحن يتحملها العميل.
            </p>
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-4 flex items-center gap-3">
              ...
              <p className="text-purple-800">
                في حال طلب الإرجاع، يتحمل العميل تكلفة الشحن كاملة. يتم استرداد قيمة المنتج فقط.
              </p>
            </div>
          </section>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-600">
                  سيتم إرجاع قيمة المنتج فقط (بدون تكلفة الشحن) إلى نفس وسيلة الدفع المستخدمة عند الشراء. 
