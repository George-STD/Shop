...
const ContactPage = () => {
  ...
  const contactInfo = [
    { icon: FiPhone, title: '???? ???', value: '+966 50 123 4567', link: 'tel:+966501234567' },
    { icon: FaWhatsapp, title: '??????', value: '+966 50 123 4567', link: 'https://wa.me/966501234567' },
    { icon: FiMail, title: '?????? ??????????', value: 'info@hadaya.sa', link: 'mailto:info@hadaya.sa' },
    { icon: FiClock, title: '????? ?????', value: '????? - ??????: 9? - 9?', link: null },
  ]
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    ???? ?? <a href="/faq" className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600 hover:underline">??????? ???????</a> ?????? ??? ?????? ?????
                  </p>
                </div>
              </div>
            </div>
