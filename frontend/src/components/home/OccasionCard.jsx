...
const OccasionCard = ({ name, icon, color }) => {
  return (
    <Link 
      ...
      className="group"
    >
      <div className={`occasion-card relative overflow-hidden rounded-2xl p-6 ${color} text-white text-center transition-all duration-500 hover:scale-105 hover:shadow-xl hover:shadow-purple-500/20`}>
        {/* Decorative sparkle */}
